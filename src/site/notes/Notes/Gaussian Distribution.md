---
{"dg-publish":true,"permalink":"/notes/gaussian-distribution/","noteIcon":"📝","created":"2024-08-02T10:46:38.344+07:00","updated":"2024-08-02T10:48:12.250+07:00"}
---
...
$$
>[!note]+
>Do tác giả đưa chứng minh này vào phần bài tập nên mình cũng sẽ cố gắng chứng minh trong phần bài tập luôn. Phần bài tập nằm ở [[Notes/Exercises Part I\|Exercises Part I]].
...
$$
>[!note]+
>Như ta đã nói ở phần trước ([[Notes/Introduction (Prob)\|Introduction (Prob)]]), khi $X$ và $Y$ độc lập với nhau thì:
>$$
p(X, Y) = p(X)p(Y)
>$$
...
Phần trước: [[Notes/Bayesian Probabilities\|Bayesian Probabilities]]
Phần sau: [[Notes/Curve Fitting Revisited\|Curve Fitting Revisited]]
